...
PMIX_DECLSPEC int pmix_hash_table_get_first_key_ptr(pmix_hash_table_t *table, void* *key,
...
PMIX_DECLSPEC int pmix_hash_table_get_next_key_ptr(pmix_hash_table_t *table, void* *key,
