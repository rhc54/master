 ...
 */
PMIX_DECLSPEC PMIX_CLASS_DECLARATION(mca_base_var_file_value_t);
 ...
 */
PMIX_DECLSPEC int mca_base_var_group_get_internal (const int group_index, mca_base_var_group_t **group, bool invalidok);
 ...
 */
PMIX_DECLSPEC int mca_base_parse_paramfile(const char *paramfile, pmix_list_t *list);
 ...
 */
PMIX_DECLSPEC int mca_base_var_group_add_var (const int group_index, const int param_index);
 ...
 */
PMIX_DECLSPEC int mca_base_var_group_add_pvar (const int group_index, const int param_index);
 ...
 */
PMIX_DECLSPEC int mca_base_var_generate_full_name4 (const char *project, const char *framework,
 ...
 */
PMIX_DECLSPEC int mca_base_internal_env_store(void);
 ...
 */
PMIX_DECLSPEC int mca_base_var_group_init (void);
PMIX_DECLSPEC int mca_base_var_group_finalize (void);
