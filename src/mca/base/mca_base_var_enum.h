 ...
 */
PMIX_DECLSPEC PMIX_CLASS_DECLARATION(mca_base_var_enum_t);
 ...
 * returns.
 */
PMIX_DECLSPEC int mca_base_var_enum_create (const char *name, const mca_base_var_enum_value_t values[],
 ...
 * returns.
 */
PMIX_DECLSPEC int mca_base_var_enum_create_flag (const char *name, const mca_base_var_enum_value_flag_t flags[],
