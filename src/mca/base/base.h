...
PMIX_DECLSPEC PMIX_CLASS_DECLARATION(mca_base_component_list_item_t);
...
PMIX_DECLSPEC PMIX_CLASS_DECLARATION(mca_base_component_priority_list_item_t);

/*
 * Public variables
 */
PMIX_DECLSPEC extern char *mca_base_component_path;
PMIX_DECLSPEC extern bool mca_base_component_show_load_errors;
PMIX_DECLSPEC extern bool mca_base_component_disable_dlopen;
PMIX_DECLSPEC extern char *mca_base_system_default_path;
PMIX_DECLSPEC extern char *mca_base_user_default_path;
 ...
 */
PMIX_DECLSPEC int mca_base_open(void);
 ...
 */
PMIX_DECLSPEC int mca_base_close(void);

/**
 * A generic select function
 *
 */
PMIX_DECLSPEC int mca_base_select(const char *type_name, int output_id,
 ...
 *
 */
PMIX_DECLSPEC int mca_base_is_component_required(pmix_list_t *components_available,
...
PMIX_DECLSPEC int mca_base_component_compare_priority(mca_base_component_priority_list_item_t *a,
                                                      mca_base_component_priority_list_item_t *b);
PMIX_DECLSPEC int mca_base_component_compare(const mca_base_component_t *a,
                                             const mca_base_component_t *b);
PMIX_DECLSPEC int mca_base_component_compatible(const mca_base_component_t *a,
                                                const mca_base_component_t *b);
PMIX_DECLSPEC char * mca_base_component_to_string(const mca_base_component_t *a);

/* mca_base_component_find.c */

PMIX_DECLSPEC int mca_base_component_find (const char *directory, mca_base_framework_t *framework,
 ...
 * filter flags.
 */
PMIX_DECLSPEC int mca_base_components_filter (mca_base_framework_t *framework, uint32_t filter_flags);
...
PMIX_DECLSPEC int mca_base_component_find_finalize(void);

/* mca_base_components_register.c */
PMIX_DECLSPEC int mca_base_framework_components_register (struct mca_base_framework_t *framework,
                                                          mca_base_register_flag_t flags);

/* mca_base_components_open.c */
PMIX_DECLSPEC int mca_base_framework_components_open (struct mca_base_framework_t *framework,
                                                      mca_base_open_flag_t flags);

PMIX_DECLSPEC int mca_base_components_open(const char *type_name, int output_id,
 ...
 */
PMIX_DECLSPEC void mca_base_component_close (const mca_base_component_t *component, int output_id);
...
PMIX_DECLSPEC int mca_base_components_close(int output_id, pmix_list_t *components_available,
                                            const mca_base_component_t *skip);

PMIX_DECLSPEC int mca_base_framework_components_close (struct mca_base_framework_t *framework,
						       const mca_base_component_t *skip);
