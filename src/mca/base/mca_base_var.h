 ...
 */
PMIX_DECLSPEC PMIX_CLASS_DECLARATION(mca_base_var_t);
 ...
 */
PMIX_DECLSPEC int mca_base_var_init(void);
 ...
 * successfully.
 */
PMIX_DECLSPEC int mca_base_var_register (const char *project_name, const char *framework_name,
 ...
 * its framework.
 */
PMIX_DECLSPEC int mca_base_component_var_register (const mca_base_component_t *component,
 ...
 */
PMIX_DECLSPEC int mca_base_framework_var_register (const mca_base_framework_t *framework,
 ...
 */
PMIX_DECLSPEC int mca_base_var_register_synonym (int synonym_for, const char *project_name,
 ...
 */
PMIX_DECLSPEC int mca_base_var_deregister(int vari);
 ...
 */
PMIX_DECLSPEC int mca_base_var_get_value (int vari, const void *value,
 ...
 * settable.
 */
PMIX_DECLSPEC int mca_base_var_set_value (int vari, const void *value, size_t size,
                                          mca_base_var_source_t source,
                                          const char *source_file);
 ...
 */
PMIX_DECLSPEC int mca_base_var_env_name(const char *param_name,
                                        char **env_name);
 ...
 */
PMIX_DECLSPEC int mca_base_var_find (const char *project_name,
 ...
 */
PMIX_DECLSPEC int mca_base_var_find_by_name (const char *full_name, int *vari);
 ...
 */
PMIX_DECLSPEC int mca_base_var_check_exclusive (const char *project,
                                                const char *type_a,
 ...
 */
PMIX_DECLSPEC int mca_base_var_set_flag(int vari, mca_base_var_flag_t flag,
                                        bool set);
 ...
 */
PMIX_DECLSPEC int mca_base_var_get (int vari, const mca_base_var_t **var);
 ...
 */
PMIX_DECLSPEC int mca_base_var_get_count (void);
 ...
 */
PMIX_DECLSPEC int mca_base_var_build_env(char ***env, int *num_env,
                                         bool internal);
 ...
 */
PMIX_DECLSPEC int mca_base_var_finalize(void);
 ...
 */
PMIX_DECLSPEC int mca_base_var_dump(int vari, char ***out, mca_base_var_dump_type_t output_type);
 ...
 */
PMIX_DECLSPEC int mca_base_var_process_env_list(char ***argv);
PMIX_DECLSPEC int mca_base_var_process_env_list_from_file(char ***argv);
