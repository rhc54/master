...
static int register_components(mca_base_framework_t *framework)
{
    ...
    PMIX_LIST_FOREACH_SAFE(cli, next, &framework->framework_components, mca_base_component_list_item_t) {
        ...
        if (NULL != component->mca_register_component_params) {
            pmix_output_verbose (MCA_BASE_VERBOSE_COMPONENT, output_id, "mca: base: components_register: "
        ...
        mca_base_component_var_register (component, "major_version", NULL, MCA_BASE_VAR_TYPE_INT, NULL,
                                         ...
                                         PMIX_INFO_LVL_9, MCA_BASE_VAR_SCOPE_CONSTANT,
