 ...
 */
PMIX_DECLSPEC PMIX_CLASS_DECLARATION(mca_base_var_group_t);
 ...
 */
PMIX_DECLSPEC int mca_base_var_group_register(const char *project_name,
 ...
 * @return pmix error code on Error
 */
PMIX_DECLSPEC int mca_base_var_group_component_register (const mca_base_component_t *component,
                                                         const char *description);
 ...
 */
PMIX_DECLSPEC int mca_base_var_group_deregister (int group_index);
 ...
 */
PMIX_DECLSPEC int mca_base_var_group_find (const char *project_name,
                                           const char *framework_name,
                                           const char *component_name);
 ...
 * @returns PMIX_ERR_NOT_FOUND if not found
 */
PMIX_DECLSPEC int mca_base_var_group_find_by_name (const char *full_name, int *index);
 ...
 * the pointer.
 */
PMIX_DECLSPEC int mca_base_var_group_get (const int group_index,
 ...
 */
PMIX_DECLSPEC int mca_base_var_group_set_var_flag (const int group_index, int flags,
                                                   bool set);
 ...
 */
PMIX_DECLSPEC int mca_base_var_group_get_count (void);
 ...
 */
PMIX_DECLSPEC int mca_base_var_group_get_stamp (void);
