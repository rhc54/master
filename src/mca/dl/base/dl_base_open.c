...
#include "pmix/mca/dl/base/static-components.h"


/*
 * Globals
 */
pmix_dl_base_module_t *pmix_dl = NULL;
pmix_dl_base_component_t *pmix_dl_base_selected_component = NULL;
 ...
 */
int pmix_dl_base_open(mca_base_open_flag_t flags)
{
    /* Open up all available components */
    return mca_base_framework_components_open(&pmix_dl_base_framework, flags);
}
...
/* VERY IMPORTANT: This framework is static, and is opened before any
   ...
   framework. */
MCA_BASE_FRAMEWORK_DECLARE(pmix, dl, "Dynamic loader framework",
                           NULL /* register */,
                           pmix_dl_base_open /* open */,
                           NULL /* close */,
