...
AC_DEFUN([MCA_pmix_dl_dlopen_PRIORITY], [80])

#
# Force this component to compile in static-only mode
#
AC_DEFUN([MCA_pmix_dl_dlopen_COMPILE_MODE], [
...
# ------------------------------------------------
AC_DEFUN([MCA_pmix_dl_dlopen_CONFIG],[
    AC_CONFIG_FILES([pmix/mca/dl/dlopen/Makefile])
    ...
    pmix_dl_dlopen_happy=no
    AS_IF([test "$enable_dl_dlopen" != "no"],
          [OPAL_CHECK_PACKAGE([pmix_dl_dlopen],
              [dlfcn.h],
              [dl],
              [dlopen],
              [],
              [],
              [],
              [pmix_dl_dlopen_happy=yes],
              [pmix_dl_dlopen_happy=no])
          ])

    AS_IF([test "$pmix_dl_dlopen_happy" = "yes"],
          [pmix_dl_dlopen_ADD_LIBS=$pmix_dl_dlopen_LIBS
           $1],
          [$2])

    AC_SUBST(pmix_dl_dlopen_LIBS)
])
