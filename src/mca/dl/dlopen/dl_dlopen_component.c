 ...
 */
const char *pmix_dl_dlopen_component_version_string =
...
pmix_dl_dlopen_component_t mca_dl_dlopen_component = {
...
static int dlopen_component_register(void)
{
    ...
    mca_dl_dlopen_component.filename_suffixes =
        pmix_argv_split(mca_dl_dlopen_component.filename_suffixes_mca_storage,
                        ',');
...
static int dlopen_component_close(void)
{
    if (NULL != mca_dl_dlopen_component.filename_suffixes) {
        pmix_argv_free(mca_dl_dlopen_component.filename_suffixes);
...
static int dlopen_component_query(mca_base_module_t **module, int *priority)
{
    ...
    *module = &pmix_dl_dlopen_module.super;
