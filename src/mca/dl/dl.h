...
typedef struct pmix_dl_handle_t pmix_dl_handle_t;
 ...
 * freed during the call to pmix_dl_base_module_dlclose_fn_t).
 *
 ...
 * change after successive calls to pmix_dl API calls.
 */
typedef int (*pmix_dl_base_module_open_fn_t)
 ...
 * change after successive calls to pmix_dl API calls.
 */
typedef int (*pmix_dl_base_module_lookup_fn_t)
    (pmix_dl_handle_t *handle, const char *symbol, void **ptr, char **err_msg);
 ...
 */
typedef int (*pmix_dl_base_module_close_fn_t)
    (pmix_dl_handle_t *handle);
 ...
 */
typedef int (*pmix_dl_base_module_foreachfile_fn_t)
 ...
 */
struct pmix_dl_base_component_1_0_0_t {
    /** MCA base component */
...
typedef struct pmix_dl_base_component_1_0_0_t pmix_dl_base_component_1_0_0_t;
typedef struct pmix_dl_base_component_1_0_0_t pmix_dl_base_component_t;

/**
 * Structure for DL modules
 */
struct pmix_dl_base_module_1_0_0_t {
    mca_base_module_2_0_0_t                 super;

    /** Open / close */
    pmix_dl_base_module_open_fn_t           open;
    pmix_dl_base_module_close_fn_t          close;

    /** Lookup a symbol */
    pmix_dl_base_module_lookup_fn_t         lookup;

    /** Iterate looking for files */
    pmix_dl_base_module_foreachfile_fn_t    foreachfile;
};
typedef struct pmix_dl_base_module_1_0_0_t pmix_dl_base_module_1_0_0_t;
typedef struct pmix_dl_base_module_1_0_0_t pmix_dl_base_module_t;
