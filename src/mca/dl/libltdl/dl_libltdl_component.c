...
#include "pmix/mca/base/mca_base_var.h"
 ...
 */
const char *pmix_dl_libltdl_component_version_string =
...
pmix_dl_libltdl_component_t mca_dl_libltdl_component = {
...
static int libltdl_component_query(mca_base_module_t **module, int *priority)
{
    ...
    *module = &pmix_dl_libltdl_module.super;
