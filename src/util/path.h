 ...
 */
PMIX_DECLSPEC char *pmix_path_find(char *fname, char **pathv, int mode,
 ...
 * The caller is responsible for freeing the returned string.
 */
PMIX_DECLSPEC char *pmix_path_findv(char *fname, int mode,
 ...
 */
PMIX_DECLSPEC bool pmix_path_is_absolute( const char *path );
 ...
 * will be returned.
 */
PMIX_DECLSPEC char* pmix_find_absolute_path( char* app_name ) __pmix_attribute_warn_unused_result__;
 ...
 * The caller is responsible for freeing the returned string.
 */
PMIX_DECLSPEC char *pmix_path_access(char *fname, char *path, int mode) __pmix_attribute_malloc__ __pmix_attribute_warn_unused_result__;
 ...
 * @retval false               otherwise
 */
PMIX_DECLSPEC bool pmix_path_nfs(char *fname, char **fstype) __pmix_attribute_warn_unused_result__;
