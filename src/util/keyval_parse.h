 ...
 */
PMIX_DECLSPEC int pmix_util_keyval_parse(const char *filename,
                                         pmix_keyval_parse_fn_t callback);

PMIX_DECLSPEC int pmix_util_keyval_parse_init(void);

PMIX_DECLSPEC int pmix_util_keyval_parse_finalize(void);

PMIX_DECLSPEC int pmix_util_keyval_save_internal_envars(pmix_keyval_parse_fn_t callback);
