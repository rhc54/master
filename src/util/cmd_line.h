...
BEGIN_C_DECLS
     ...
     */
    PMIX_DECLSPEC PMIX_CLASS_DECLARATION(pmix_cmd_line_t);
     ...
     * \endcode
     */
    PMIX_DECLSPEC int pmix_cmd_line_create(pmix_cmd_line_t *cmd,
     ...
     */
     PMIX_DECLSPEC int pmix_cmd_line_add(pmix_cmd_line_t *cmd,
                                         pmix_cmd_line_init_t *table);
     ...
     *
     */
    PMIX_DECLSPEC int pmix_cmd_line_make_opt_mca(pmix_cmd_line_t *cmd,
     ...
     *
     */
    PMIX_DECLSPEC int pmix_cmd_line_make_opt3(pmix_cmd_line_t *cmd,
                                              char short_name,
                                              const char *sd_name,
     ...
     */
    PMIX_DECLSPEC int pmix_cmd_line_parse(pmix_cmd_line_t *cmd,
                                          bool ignore_unknown,
                                          int argc, char **argv);
     ...
     */
    PMIX_DECLSPEC char *pmix_cmd_line_get_usage_msg(pmix_cmd_line_t *cmd) __pmix_attribute_malloc__ __pmix_attribute_warn_unused_result__;
     ...
     */
    PMIX_DECLSPEC bool pmix_cmd_line_is_taken(pmix_cmd_line_t *cmd,
     ...
     * function.
     */
    PMIX_DECLSPEC int pmix_cmd_line_get_argc(pmix_cmd_line_t *cmd) __pmix_attribute_unused__;
     ...
     */
    PMIX_DECLSPEC char *pmix_cmd_line_get_argv(pmix_cmd_line_t *cmd,
                                               int index);
     ...
     */
    PMIX_DECLSPEC int pmix_cmd_line_get_ninsts(pmix_cmd_line_t *cmd,
                                               const char *opt) __pmix_attribute_nonnull__(1) __pmix_attribute_nonnull__(2);
     ...
     * caller.
     */
    PMIX_DECLSPEC char *pmix_cmd_line_get_param(pmix_cmd_line_t *cmd,
                                                const char *opt,
                                                int instance_num,
                                                int param_num);
     ...
     */
    PMIX_DECLSPEC int pmix_cmd_line_get_tail(pmix_cmd_line_t *cmd, int *tailc,
                                             char ***tailv);
