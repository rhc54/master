 ...
 */
PMIX_DECLSPEC int pmix_show_help_init(void);
 ...
 */
PMIX_DECLSPEC int pmix_show_help_finalize(void);
...
PMIX_DECLSPEC extern pmix_show_help_fn_t pmix_show_help;
 ...
 */
PMIX_DECLSPEC char* pmix_show_help_vstring(const char *filename,
                                          const char *topic,
                                          bool want_error_header, va_list ap);
 ...
 */
PMIX_DECLSPEC int pmix_show_help_add_dir(const char *directory);
